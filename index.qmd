...
This workshop will introduce the basics of the Python programming language for data science, with a focus on working with tabular data using the Pandas library.

The course is aimed at graduate students, postdocs, faculty, and other researchers across campus who are interested in learning how to use Python for basic data analysis. You don't need to have coding experience or any previous knowledge of Python to attend this workshop.
